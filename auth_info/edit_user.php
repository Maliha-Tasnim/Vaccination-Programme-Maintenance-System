...
if(!$e_user)
{
  $session->msg("d","It seems, user ID is missing.");
...
if(isset($_POST['update'])) 
{
  ...
  if(empty($errors))
  {
    ...
    {
      $session->msg('s',"User account is updated.");
      redirect('../auth_info/edit_user.php?id='.(int)$e_user['id'], false);
    } 
    else 
    {
  ...
  <div class="row">
    ...
    <div class="col-md-6">
     <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form method="post" action="../auth_info/edit_user.php?id=<?php echo (int)$e_user['id'];?>" class="clearfix">
    ...
    <div class="col-md-6">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form action="../auth_info/edit_user.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
            <div class="form-group">
