...
global $year;
$sqlYear = "SELECT epi_year_es FROM epi_schedule_temp_change";
$resultYear = mysqli_query($conn, $sqlYear);
while($row = $resultYear->fetch_assoc())
   $year = $row["epi_year_es"];

global $schedule_id;
$sqlSchedule = "SELECT schedule_id FROM epi_schedule_temp_change";
...
$sqlYear_duplication = "SELECT epi_year_es FROM epi_schedule_temp_change";
...
$sqlUnion_duplication = "SELECT union_id FROM epi_schedule_temp_change";
...
if(isset($_POST['save']))
{
    ...
    $sqlTruncateEpiCenterTempTable = "TRUNCATE TABLE epi_center_temp_change";
...
<?php include_once('../footer.php');?>  
 ...
 $(document).ready(function(){  
      ...
      {  
           $.ajax({  
                url:"../change_center_scheduler/epi_center_table_select.php",  
                method:"POST",  
      ...
      {  
           $.ajax({  
                url:"../change_center_scheduler/epi_center_table_edit.php",  
                method:"POST",  
